...
> 🔗 **Note:** The **Robotic Cell Management** component (e.g., task coordination, conveyor integration) is maintained in a **separate but interlinked repository**, available here:  
> 👉 [Robotic Cell Management Repository](https://github.com/rahulpanchall7/Robotic-Cell-Management)
...
4. ```
    ros2 run robot_moveit ur5_controller.py <shoulder_pan_joint> <shoulder_lift_joint> <elbow_joint> <wrist_1_joint> <wrist_2_joint> <wrist_3_joint>
   ```
![image](https://github.com/user-attachments/assets/9ce7755c-8776-418f-b4e9-2abbaf361a8b)

5. To bring back to home position
   ```
    ros2 run cobot_moveit ur5_controller.py --reset_home 
   ```
     
6. ```
    ros2 run robot_description compute_camera_pose.py
    ```
