...
: ${AMENT_CURRENT_PREFIX:="/home/rahul/camera_ws/install/robot_moveit"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/robot_moveit/environment/pythonpath.sh"
